...
df_visual = pd.melt(df_scores.sort_values(['utility','AllyHelp_Score'],ascending=[False,False])[:10][['championName','AllyHelp_Score','AllyUseless_Score']],id_vars='championName',var_name='type_score',value_name='score')
